...
with the spectrometer software TopSpin, and further downstream 
...
For completeness - and for teaching purposes - the next section ([Startpoint: FID](#import-fid)) 
briefly demonstrates how to process raw FIDs to obtain spectra.
