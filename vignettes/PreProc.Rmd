...
```{r spec-overlay-single, fig.show='hold', fig.width = 7.2, fig.height = 4, message=FALSE, warning=FALSE}
...
```{r spec-overlay-mlt, fig.show='hold', fig.width = 7, fig.height = 5, message=FALSE, warning=FALSE}
